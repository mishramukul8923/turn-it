  ...
  try {
    ...
    if (user) {
      ...
      const checkoutSession = await stripe.checkout.sessions.create({
        ...
        metadata: {
          user_id: data.planData.user_id,
          expired_at: data.planData.expired_at,
          planType: data.planData.planType,
          email: data.planData.email,
          price: data.planData.price,
          name: data.planData.name,
